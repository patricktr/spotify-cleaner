...
You will need: a GitHub account, a Vercel account, a Spotify Developer app, and an Anthropic API key.
...
- Optional-LLM mode: a flag to run the heuristic layer only, skipping the Claude call entirely for fully offline / zero-LLM-cost operation.
